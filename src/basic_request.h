...
template<typename RequestBuilderType>
class BasicRequest {
public:
...
//  {}
  ...
  BasicRequest() : request_builder_(new RequestBuilderType)
  {}
...
//  BasicRequest() = delete;
  ...
  BasicRequest &operator=(BasicRequest &request) = delete;
  ...
  inline RequestBuilderType &request_builder() { return *request_builder_; }
...
//  }
  ...
  inline bool Build() { return request_builder_->Build(); }
...
//  std::shared_ptr<Socket> socket_;
  std::unique_ptr<RequestBuilderType> request_builder_;

  std::string host_;
  std::uint16_t port_;
};

typedef BasicRequest<StreamRequestBuilder> Request;
