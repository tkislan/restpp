...
public:
  inline bool set_method(const std::string &method) { method_ = method; }
  inline bool set_path(const std::string &path) { path_ = path; }
  inline bool add_query_param(const std::string &name, const std::string &value) { query_params_.push_back(std::make_pair(name, value)); }

  inline bool add_header(const std::string &name, const std::string &value) { headers_.push_back(std::make_pair(name, value)); }
